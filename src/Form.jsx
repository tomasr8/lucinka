...
import { Calendar, Weight, Ruler, FileText, Plus, X, CheckCircle } from "lucide-react";

export default function FormModal({ setState }) {
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <div>
                                <h2 className="text-2xl font-bold text-gray-800">Health Entry</h2>
                                <p className="text-gray-500 text-sm mt-1">Track your daily health metrics</p>
                            </div>
                            <button
                                onClick={closeModal}
