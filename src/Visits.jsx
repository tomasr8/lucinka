...
import { ChevronLeft, ChevronRight, Calendar, Clock, MapPin, User, X, FileText, Plus, Trash2, CheckCircle } from "lucide-react";

export default function VisitsPage({ state, setState }) {
    ...
    const renderCalendarDays = () => {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            days.push(
                <div
                    key={day}
                    className={`p-2 min-h-24 border border-gray-100 rounded-lg cursor-pointer transition-all hover:bg-gray-50 ${isToday ? 'bg-teal-50 border-teal-300' : ''
                        }`}
                ...
                >
                    ...
                    {dayVisits.map(visit => (
                        <div
                            key={visit.id}
                            className={`text-xs p-1 rounded mb-1 ${visit.status === 'completed'
        ...
        <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-50 p-6">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800 mb-2">Medical Visits</h1>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-1">Schedule a new medical appointment</p>
                            </div>
                            <button
                                onClick={() => setIsAddModalOpen(false)}
                                className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between p-6 border-b border-gray-200">
                            <div className="flex items-start gap-3">
                                <div className={`p-3 rounded-lg ${selectedVisit.status === 'completed'
                                    ? 'bg-gray-100'
                                    : 'bg-teal-100'
                                    }`}>
                                    <Calendar className={`w-6 h-6 ${selectedVisit.status === 'completed'
                                        ? 'text-gray-600'
                                        : 'text-teal-600'
                                        }`} />
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-gray-800">{selectedVisit.type}</h3>
                                    <p className={`text-sm mt-1 px-3 py-1 rounded-full inline-block ${selectedVisit.status === 'completed'
                                        ? 'bg-gray-100 text-gray-700'
                                        : 'bg-teal-100 text-teal-700'
                                        }`}>
                                        {selectedVisit.status === 'completed' ? 'Completed' : 'Upcoming'}
                                    </p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-gray-800">{selectedVisit.time}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-gray-800">{selectedVisit.doctor}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-gray-800">{selectedVisit.location}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800 mt-1">{selectedVisit.notes}</p>
                                </div>
                            </div>
                        </div>
